...
2. la división por (\sqrt{d_k}) estabiliza los valores obtenidos;
3. `softmax` transforma las puntuaciones en pesos relativos;
4. los pesos se aplican a los valores (V) para construir el resultado.
...
Bahdanau, D., Cho, K. y Bengio, Y. (2015). *Neural Machine Translation by Jointly Learning to Align and Translate*. International Conference on Learning Representations.
