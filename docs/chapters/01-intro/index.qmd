...
Los Large Language Models (LLM) representan uno de los cambios más importantes en la historia reciente de la Ingeniería del Software. Sin embargo, para comprender realmente su impacto no basta con estudiar su funcionamiento interno.

Antes debemos entender **qué problema intentan resolver** y **por qué los modelos tradicionales de programación resultaban insuficientes para determinadas clases de problemas**.
